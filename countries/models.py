...
class Country(models.Model):
	...
	name = models.CharField(_('Official name (CAPS)'), max_length=128, db_index=True)
	printable_name = models.CharField(_('Country name'), max_length=128,db_index=True, unique=True)
...
class UsState(models.Model):
	...
	name = models.CharField(_('State name'), max_length=50, null=False, unique=True, db_index=True)
